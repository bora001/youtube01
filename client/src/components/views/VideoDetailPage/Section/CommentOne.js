    ...
    return (
        ...
        <div style={{}}>
            ...
            {userComment && userComment.map((info, index) => (
                ...
                <Comment
                        actions={[
                            [<LikeButton key="comment-nested-liked-to" info={info} infoId={info._id} />],
                            [<span key="comment-nested-reply-to" replyid={info._id} onClick={onReply}> Reply to </span>]
                        ]}
                ...
                <ReplyInfo replyinfo={info} />
                    ...
                    {clicked && clicked == info._id ?
                        Reply &&
                        <form onSubmit={onComment} style={{ marginLeft: '5%',marginBottom: '5%', height: 'inherit', flexDirection: 'row', justifyContent: 'initial', alignItems: 'initial' }}>
